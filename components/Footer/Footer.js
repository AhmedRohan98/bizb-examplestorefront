            ...
            <a
              onClick={() => {
                const dataLayer = {
                  dataLayer: {
                    event: 'social_share',
                    social: 'instagram', // Replace with the social media platform
                    action: 'share', // Replace with the specific action (e.g., share, like, follow, etc.)
                    target: 'https://www.instagram.com/bizb.store/?_ga=2.46482023.1960989760.1689242030-358638331.1683619134', // Replace with the URL of the shared content
                  },
                };

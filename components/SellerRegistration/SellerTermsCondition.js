  ...
  return (
    <div>
      ...
      <div className={classes.styleofdiv2}>
        <Typography variant="body2" style={text2}>
      ...
      <div className={classes.styleofdiv4}>
        <div className={classes.styleofdiv2}>
          <div className={classes.styleofdiv3}>
            <Typography variant="body2" style={text1} textAlign="left">
              1. Exclusive Listing:
            </Typography>
          </div>
          <Typography variant="body2" style={text2} textAlign="left">
        ...
        <div className={classes.styleofdiv2}>
          <div className={classes.styleofdiv3}>
            <Typography variant="body2" style={text1}>
              2. Commission:
            </Typography>
          </div>
          <Typography variant="body2" style={text2}>

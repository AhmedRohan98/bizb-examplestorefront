    ...
    <>
      {typeof window !== "undefined" && (
        <Grid container lg={12} sm={12} md={12} align="center" justify="center" alignItems="center">
          ...
          <Grid item lg={6} sm={6} md={12} xs={12}    container   className={classes.maingrid} xsOffset={3}
  direction="row"
  alignItems="flex-start"
  justifyContent="space-evenly"
  >
     <Grid item lg={6} sm={6} md={6} xs={6}  className={classes.rootimg} >
      ...
      <div className={classes.cart}>
       ...
       <Box className={classes.maintitle}>
        ...
        <Typography gutterBottom variant="h4" >{`:${firstarray.names1.size}`}</Typography></div>
        <div className={classes.size}>    <strike>{firstarray.names1.price}</strike> 

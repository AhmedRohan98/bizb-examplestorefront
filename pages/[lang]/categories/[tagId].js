...
export async function getStaticPaths() {
  const tags = await fetchTags("cmVhY3Rpb24vc2hvcDpyaWFhR0xlMlJqYW5UQlF6dw==");
  let paths = [];
...
export async function getStaticProps({ params: { lang, tagId }, ...context }) {
  ...
  const categories = await fetchAllCategories(["cmVhY3Rpb24vc2hvcDpyaWFhR0xlMlJqYW5UQlF6dw=="], [tagId]);
  ...
  return {
    props: {
      ...
      tagId,
      category: categories,
      ...(await fetchTags("cmVhY3Rpb24vc2hvcDpyaWFhR0xlMlJqYW5UQlF6dw==")),
    },
  };
}
